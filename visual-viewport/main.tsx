...
import { VisualViewport, type InteractiveWidgetValue } from '../src/pages/VisualViewport/VisualViewport';
...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <Layout>
      <VisualViewport interactiveWidget={getInteractiveWidgetValue()} />
    </Layout>
  </StrictMode>
);
